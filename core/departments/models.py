...
class JobTitle(BaseModel):
    ...
    titer_am = models.CharField(max_length=255, null=True, blank=True, verbose_name=_("Titer (Amharic)"))
    titer_en = models.CharField(max_length=255, null=True, blank=True, verbose_name=_("Titer (English)"))
